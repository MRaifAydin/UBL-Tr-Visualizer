    ...
    >
      ...
      >
        <div className="flex items-center justify-between px-5 h-[53px] border-b border-gray-200 shrink-0">
          <h2 className="text-sm font-semibold text-gray-700">Geçmişe Kaydet</h2>
          <button
            type="button"
            onClick={onCancel}
            title="Kapat"
        ...
        <div className="p-5 flex flex-col gap-2">
          <label htmlFor="history-name" className="text-xs font-medium text-gray-700">
            Belge adı
          </label>
          <input
            id="history-name"
          ...
          {isEmpty && (
            <p className="text-xs text-gray-500">İsim boş bırakılamaz.</p>
          )}
        </div>
